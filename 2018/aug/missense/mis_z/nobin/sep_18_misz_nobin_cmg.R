...
# Date Last Modified: Sep 18, 2018
...
write.table(result, file=paste(c(as.character(Sys.Date()), "_", FILTER_PARAM, "_Default_nobin_cmg.tsv"), collapse = ''), sep="\t", quote=FALSE, row.names=FALSE)
